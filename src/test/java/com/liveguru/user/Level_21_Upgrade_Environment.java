...
public class Level_21_Upgrade_Environment extends AbstractTest {
	...
	public void beforeClass(String browserName) {
		String environmentMT = System.getProperty("Environ");
		System.out.println("Server name run by command line=" + environmentMT.toLowerCase());

		ConfigFactory.setProperty("environment", environmentMT.toLowerCase());
		env = ConfigFactory.create(Environment.class);

		driver = getBrowserDriver(browserName, env.url());

		System.out.println("Url= "+env.url());
		System.out.println("DB Host name "+env.getDBHostname());
		System.out.println("DB User name "+env.getDBUsername());
		System.out.println("DB Password "+env.getDBPassword());
