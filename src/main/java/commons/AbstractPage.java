...
//////
	...
	public boolean isFileLoaded(WebDriver driver, String fileName) {
		waitToElementClickAble(driver, LiveGuruAbstractPageUI.DYNAMIC_IMAGE_TEXT, fileName);
		return isElementDisplayed(driver, LiveGuruAbstractPageUI.DYNAMIC_IMAGE_TEXT, fileName);
	}

	public void clickToStartButton(WebDriver driver, String fileName) {
		waitToElementClickAble(driver, LiveGuruAbstractPageUI.DYNAMIC_IMAGE_START_BUTTON, fileName);
		clickToElement(driver, LiveGuruAbstractPageUI.DYNAMIC_IMAGE_START_BUTTON, fileName);
	}

	public boolean isFileUploadedSuccess(WebDriver driver, String fileName) {
		waitToElementVisible(driver, LiveGuruAbstractPageUI.DYNAMIC_IMAGE_LINK, fileName);
		return isElementDisplayed(driver, LiveGuruAbstractPageUI.DYNAMIC_IMAGE_LINK, fileName);
	}
